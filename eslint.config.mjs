...
export default [
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        applyWorkbookValidations: "readonly",
        applyMockWorkbookValidations: "readonly",
        applyWorkbookValidationsToSpreadsheet_: "readonly",
        ...
        validateQuickLogReferences: "readonly",
